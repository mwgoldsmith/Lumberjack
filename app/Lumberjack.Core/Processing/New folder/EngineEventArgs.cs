...
namespace Medidata.Lumberjack.Core.Processors
{
    ...
    public class EngineEventArgs : EventArgs
    {
        ...
        public EngineEventArgs(EngineActionEnum engineAction, LogFile logFile, EngineMetrics engineMetrics)
        ...
        /// <param name="engineAction"></param>
        /// <param name="logFile"></param>
        public EngineEventArgs(EngineActionEnum engineAction, LogFile logFile) {
        ...
        /// 
        /// </summary>
        public EngineActionEnum EngineAction { get; protected set; }
